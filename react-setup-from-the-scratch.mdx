...
Source code for this tutorial can be found in my GitHub [repo](https://github.com/JanGanaCode/youtube/blob/main/react-from-the-scratch/webpack.config.js).
